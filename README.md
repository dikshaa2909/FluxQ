...
[![Vercel](https://img.shields.io/badge/Vercel-Deployed-black?logo=vercel)](https://flux-q.vercel.app)
[![Render](https://img.shields.io/badge/Render-Online-4361ee?logo=render)](https://fluxq.onrender.com/health)

---

### ● Overview
**FluxQ** is a production-grade clinical triage and queue management ecosystem. It bridges the gap between patient intake and doctor availability using a clinical-aware optimization engine.
