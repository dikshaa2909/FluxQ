    ...
    <div className="space-y-10 relative pb-20">
      ...
      {validation && (
        <div className={`glass-card border-none overflow-hidden animate-fade-in-up delay-1`}>
          <div className={`px-4 py-2 flex items-center justify-between text-[10px] font-mono-space tracking-wider uppercase ${validation.valid ? 'text-primary bg-primary/5' : 'text-severity-high bg-severity-high/5'
            }`}>
      ...
      <div className="animate-fade-in-up delay-2">
        <p className="section-label mb-5 uppercase tracking-widest">Optimization Presets</p>
        ...
        <div className="flex flex-wrap gap-8 group/tabs animate-fade-in delay-3 border-b border-border/10 pb-4">
          {[
            ...
            <button
              ...
              className={`flex items-center gap-3 transition-all ${activeTab === tab.id ? 'text-primary scale-105' : 'text-muted-foreground opacity-50 hover:opacity-100'
                }`}
            >
          ...
          {activeTab === 'weights' && (
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
              <div className="lg:col-span-3 space-y-6 animate-slide-in-left">
                <p className="section-label uppercase tracking-widest opacity-40">Weight Parameters</p>
